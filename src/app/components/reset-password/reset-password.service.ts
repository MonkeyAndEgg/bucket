...
import { resetPassword, setCurrentUser, setLoadStatus, updateAuthStatus, updateToken } from "src/app/store/auth/auth.actions";
...
export class ResetPasswordService {
  ...
  logoutUser(): void {
    ...
    this.store.dispatch(updateAuthStatus({ isAuth: false }));
    clearStorageData();
  }
}
